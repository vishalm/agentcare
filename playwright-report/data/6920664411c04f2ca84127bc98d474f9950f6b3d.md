...
- Name: AgentCare UI Tests >> Chat Conversation Flow >> should display agent response after user message
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:161:9
...
Locator: locator('.agent-message').last()
Expected string: not "Welcome!"
Received string: "
                    🤖 AgentCare Assistant
                    Welcome! I'm your intelligent healthcare scheduling assistant powered by a multi-agent system.
                    I can help you with:
                    • 📅 Booking appointments
                    • 🔍 Checking doctor availability
                    • ℹ️ Getting information about doctors and services
                    • 📋 Answering policy questions
                    How can I assist you today?
                "
Call log:
  - expect.not.toContainText with timeout 10000ms
  - waiting for locator('.agent-message').last()
    14 × locator resolved to <div class="message agent-message">…</div>
       - unexpected value "
                    🤖 AgentCare Assistant
                    Welcome! I'm your intelligent healthcare scheduling assistant powered by a multi-agent system.
                    I can help you with:
    ...
    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:169:63
```
...
- textbox "Type your message here...": I want to book an appointment
- button "Send"
```
