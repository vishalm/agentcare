...
- Name: AgentCare UI Tests >> Chat Conversation Flow >> should maintain conversation history
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:175:9
...
Call log:
  ...
  - waiting for locator('.user-message')
    ...
    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:190:51
```
...
- textbox "Type your message here...": I need help
- button "Send"
```
