...
- Name: AgentCare UI Tests >> Error Handling >> should handle server errors
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:265:9
...
Call log:
  ...
  - waiting for locator('.agent-message').last()
    ...
    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:280:59
```
...
- textbox "Type your message here...": Test server error
- button "Send"
```
