...
- Name: AgentCare UI Tests >> User Input Interactions >> should send message on Enter key press
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:84:9
...
Expected string: "Test Enter key"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('.user-message').last()

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:91:58
```
...
- textbox "Type your message here...": Test Enter key
- button "Send"
```
