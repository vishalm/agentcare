...
- Name: AgentCare UI Tests >> Agent Status Updates >> should update agent type based on message content
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:197:9
...
Expected string: "Booking Agent Active"
Received string: "Supervisor Agent Ready"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('#agentType')
    9 × locator resolved to <span id="agentType">Supervisor Agent Ready</span>
      - unexpected value "Supervisor Agent Ready"

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:204:31
```
