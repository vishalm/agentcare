...
- Name: AgentCare UI Tests >> Agent Status Updates >> should show processing state during requests
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:210:9

# Error details

```
Error: Timed out 1000ms waiting for expect(locator).toContainText(expected)

Locator: locator('#agentType')
Expected string: "Processing..."
Received string: "Supervisor Agent Ready"
Call log:
  - expect.toContainText with timeout 1000ms
  - waiting for locator('#agentType')
    5 × locator resolved to <span id="agentType">Supervisor Agent Ready</span>
      - unexpected value "Supervisor Agent Ready"

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:217:31
```
...
- textbox "Type your message here...": What doctors are available?
- button "Send"
```
