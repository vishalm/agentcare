...
- Name: AgentCare UI Tests >> Example Button Interactions >> should populate input when example button is clicked
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:109:9
...
Expected string: "cardiologist"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('.user-message').last()

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:116:58
```
