...
- Name: AgentCare UI Tests >> Error Handling >> should handle network errors gracefully
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:250:9
...
Call log:
  ...
  - waiting for locator('.agent-message').last()
    ...
    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:261:59
```
...
- textbox "Type your message here...": Test network error
- button "Send"
```
