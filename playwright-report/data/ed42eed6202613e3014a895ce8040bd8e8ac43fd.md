...
- Name: AgentCare UI Tests >> Accessibility >> should support keyboard navigation
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:300:9
...
Expected string: "Keyboard test"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('.user-message').last()

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:306:58
```
...
- textbox "Type your message here...": Keyboard test
- button "Send"
```
