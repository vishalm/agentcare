...
- Name: AgentCare UI Tests >> Accessibility >> should have proper ARIA labels and roles
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:294:9
...
Call log:
  ...
  - waiting for locator('#sendButton')
    9 × locator resolved to <button id="sendButton" class="send-button" onclick="sendMessage()">↵                    Send↵                </button>
      - unexpected value "null"

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:297:49
```
