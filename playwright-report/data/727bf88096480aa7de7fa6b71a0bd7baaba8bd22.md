...
- Name: AgentCare UI Tests >> Accessibility >> should have proper focus management
- Location: /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:285:9
...
Locator: locator('#messageInput')
Expected: focused
Received: inactive
Call log:
  - expect.toBeFocused with timeout 5000ms
  - waiting for locator('#messageInput')
    9 × locator resolved to <input type="text" id="messageInput" class="message-input" onkeypress="handleKeyPress(event)" placeholder="Type your message here..."/>
      - unexpected value "inactive"

    at /Users/vishalmishra/workspace/self/agentcare/tests/ui/agentcare-ui.spec.ts:287:51
```
