...
const Config_1 = require("../../backend/src/utils/Config");
...
describe('API Integration Tests', () => {
    ...
    beforeAll(() => {
        ...
        Config_1.Config.getInstance.mockReturnValue(mockConfig);
        config = mockConfig;
        // Set up test app
        app = (0, express_1.default)();
        logger = new Logger_1.Logger();
        metrics = new MetricsCollector_1.MetricsCollector(logger);
