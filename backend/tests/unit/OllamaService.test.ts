...
describe('OllamaService', () => {
    ...
    beforeEach(() => {
        ...
        ollamaService = new OllamaService(mockLogger, mockConfig);
    ...
    describe('generateResponse', () => {
        ...
        it('should handle API errors gracefully', async () => {
            ...
            await expect(
                ollamaService.generateResponse('Test message')
        ...
        it('should handle network errors', async () => {
            ...
            await expect(
                ollamaService.generateResponse('Test message')
            ).rejects.toThrow('Failed to generate response: Network error');
        });
    ...
    describe('analyzeIntent', () => {
        it('should analyze intent successfully', async () => {
            ...
            const result = await ollamaService.analyzeIntent(
        ...
        it('should handle intent analysis errors', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith(
                'Error analyzing intent with Ollama',
                expect.any(Object)
            );
        });
    });
