...
export class NotificationService {
     ...
     */
    public async sendAppointmentConfirmation(appointment: Appointment): Promise<void> {
     ...
     */
    public async sendAppointmentCancellation(appointment: Appointment): Promise<void> {
        this.logger.info('Sending appointment cancellation', { appointmentId: appointment.id });
     ...
     */
    public async sendAppointmentReschedule(appointment: Appointment): Promise<void> {
        this.logger.info('Sending appointment reschedule notification', { appointmentId: appointment.id });
     ...
     * @param appointment - The appointment details
     */
    public async sendAppointmentReminder(appointment: Appointment): Promise<void> {
        this.logger.info('Sending appointment reminder', { appointmentId: appointment.id });
     ...
     */
    private async mockEmailSend(emailData: { to: string; subject: string; body: string }): Promise<void> {
