...
export class FAQService {
    ...
    private faqs: FAQEntry[] = [
        ...
        },
        {
            ...
            answer: 'Appointments can be cancelled up to 24 hours in advance without penalty. Late cancellations may incur a fee.',
            priority: 1,
            createdAt: new Date(),
            updatedAt: new Date()
        },
        {
            ...
            answer: 'We are located at 123 Healthcare Ave, Medical District. Free parking is available in the adjacent garage.',
            priority: 1,
            createdAt: new Date(),
            updatedAt: new Date()
        },
        {
            ...
            answer: 'You can schedule an appointment through our AI assistant, by calling our office, or using our online portal.',
            priority: 2,
            createdAt: new Date(),
            updatedAt: new Date()
        }
     ...
     */
    public async update(id: number, updateData: Partial<FAQEntry>): Promise<FAQEntry | null> {
