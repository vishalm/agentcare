...
export class EmailService {
    ...
    public async sendConfirmation(appointment: Appointment): Promise<void> {
        this.logger.info('Sending confirmation email', { appointmentId: appointment.id });
    ...
    public async sendCancellation(appointment: Appointment): Promise<void> {
        this.logger.info('Sending cancellation email', { appointmentId: appointment.id });
    ...
    public async sendReschedule(appointment: Appointment): Promise<void> {
        this.logger.info('Sending reschedule email', { appointmentId: appointment.id });
