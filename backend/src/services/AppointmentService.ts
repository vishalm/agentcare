...
export class AppointmentService {
    ...
    public async create(appointmentData: any): Promise<Appointment> {
        ...
        const appointment: Appointment = {
            ...
            doctorName: appointmentData.doctorName || `Doctor ${appointmentData.doctorId}`,
     ...
     */
    public async getAvailableSlots(doctorId: number, startDate: Date, endDate: Date): Promise<Date[]> {
        this.logger.info('Getting available slots', { doctorId, startDate, endDate });
