...
export class BookingAgent implements IAgent {
    ...
    private async handleCreateBooking(message: string, _action: any): Promise<string> {
        ...
        return `Great! I've booked your appointment with Dr. ${appointment.doctorName} on ` +
    ...
    private async handleCancelBooking(message: string, _action: any): Promise<string> {
        ...
        return `I've cancelled your appointment with Dr. ${cancelled.doctorName} ` +
    ...
    private async handleRescheduleBooking(message: string, _action: any): Promise<string> {
        ...
        return `I've rescheduled your appointment with Dr. ${rescheduled.doctorName} ` +
